---
title: "TrinaxAI Environment Variable Reference"
...
| `TRINAXAI_MODEL_DEEP` | `string` | `qwen2.5-coder:7b` | Deep-analysis model for complex refactoring, architecture, and multi-file queries. `ultra` profile defaults to `qwen2.5-coder:14b`. |
...
| `TRINAXAI_LLM_HEAVY` | `string` | `qwen2.5-coder:7b` | Heavy fallback model when `TRINAXAI_AUTO_ROUTE=0`. Defaults to `MODEL_DEEP`. |
