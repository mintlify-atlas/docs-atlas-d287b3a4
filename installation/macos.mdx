...
sidebarTitle: "macOS"
description: "Install TrinaxAI on macOS with one command. Supports Intel and Apple Silicon Macs. Installs via Homebrew and uses launchctl for service autostart."
---
