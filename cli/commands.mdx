---
title: "TrinaxAI CLI Command Reference"
...
| `/index [path]` | Index a folder directly from within chat (defaults to `.`) |
...
| Subcommand | Description |
|---|---|
| `list-collections` (or `list`) | Show all available collections |
