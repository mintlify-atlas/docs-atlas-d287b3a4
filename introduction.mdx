...
<CardGroup cols={2}>
  ...
  <Card title="Voice & Vision" icon="microphone" href="/features/voice-and-vision">
    Full voice conversations with speech-to-text and text-to-speech, plus local image and screenshot analysis powered by `qwen2.5vl` — no third-party API required.
  </Card>
...
|---------|-----------|---------------|------------|------------|-----------|
| `4gb` | ~4 GB | `llama3.2:1b` | `qwen2.5-coder:1.5b` | `qwen2.5-coder:1.5b` | `nomic-embed-text` |
| `8gb` | ~8 GB | `llama3.2:1b` | `qwen2.5-coder:1.5b` | `qwen2.5-coder:1.5b` | `nomic-embed-text` |
| `16gb` | ~16 GB | `llama3.2:3b` | `qwen2.5-coder:3b` | `qwen2.5-coder:7b` | `bge-m3` |
| `max` | 32 GB+ | `llama3.2:3b` | `qwen2.5-coder:3b` | `qwen2.5-coder:7b` | `bge-m3` |
| `ultra` | 64 GB+ | `llama3.2:3b` | `qwen2.5-coder:7b` | `qwen2.5-coder:7b` | `bge-m3` |
...
- **Developer CLI** — `trinaxai ask`, `trinaxai chat`, `trinaxai index`, `trinaxai doctor`, `trinaxai research`, `trinaxai memory`, `trinaxai collections`, `trinaxai watch`, `trinaxai export`
