---
title: "TrinaxAI RAG API Overview"
sidebarTitle: "Overview"
description: "The TrinaxAI RAG API is a FastAPI server on port 3333. It provides OpenAI-compatible chat, collections, memory, indexing, and system control endpoints."
---
...
| `GET` | `/v1/sources/{collection}/{file}/chunks` | List individual chunks for a specific file within a collection. |
...
| `DELETE` | `/v1/memory/{id}` | Delete a memory entry by ID. |
...
| `DELETE` | `/collections/{id}` | Delete a collection and all its indexed chunks. |
...
| `401` | Unauthorized — system endpoint called without a valid token |
