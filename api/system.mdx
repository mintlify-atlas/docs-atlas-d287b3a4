...
sidebarTitle: "System"
description: "Protected /system endpoints to start, stop, and health-check TrinaxAI services. All require localhost access or an admin bearer token."
---
...
# Remote LAN or production — use Bearer token
